...
x_train = x_train.reshape(x_train.shape[0], -1, x_train.shape[-1])   # shape: 1000,8040,6
x_test = x_test.reshape(x_test.shape[0], -1, x_test.shape[-1])
y_train = y_train.reshape(y_train.shape[0], -1, y_train.shape[-1])   # shape: 1000,8040,1
