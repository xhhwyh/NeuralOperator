...
# load data
###################################
data_path = "NeuralOperator\datasets\darcy_2d\piececonst_r241_N1024_smooth1.mat"
data1 = loadmat(data_path)
data_path = "NeuralOperator\datasets\darcy_2d\piececonst_r241_N1024_smooth2.mat"
...
train_rel_l2_losses, test_rel_l2_losses, test_l2_losses = GeoFNO_train(
    x_train, y_train, x_test, y_test, config, model, save_model_name="GeoFNO_darcy_model_d4.pth"
)