...
from GeoKNO.geo_utility import preprocess_data, convert_structured_data
from GeoKNO.geokno import compute_Fourier_modes, GeoKNO, GeoKNO_train
...
if CONVERT_DATA:
    ...
    np.savez_compressed("datasets/darcy_2d/geokno_quad_equal_weight_data.npz", nnodes=nodes, node_mask=node_mask, nodes=nodes, node_weights=node_weights, features=features, directed_edges=directed_edges, edge_gradient_weights=edge_gradient_weights)
    ...
    np.savez_compressed("datasets/darcy_2d/geokno_quad_data.npz", nnodes=nodes, node_mask=node_mask, nodes=nodes, node_weights=node_weights, features=features, directed_edges=directed_edges, edge_gradient_weights=edge_gradient_weights)
    exit()
else:
    data = np.load("datasets/darcy_2d/geokno_quad_equal_weight_data.npz")
